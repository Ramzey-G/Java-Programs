...
public class Cyoa
{
    ...
    public static void main(String [] args) throws IOException{
       ...
       //  rooms[0] = current;
         ...
         node[] rooms = new node[numrooms];
         node[] orderedrooms = new node[numrooms];
             ...
             if(input.equals("q")){
                 ...
                 addToHistory(currentroom, history);
                  ...
                  //System.out.println();
                   ...
                   if(historyid>=0 &&history.next!=null){ //if number of elements in array >=0
                        historyNode temp2 = history;
                        while(temp2.next.next!=null){
                            temp2 = temp2.next;
                        }
                        currentroom = temp2.num;
                        temp2.next = null;
    ...
    private static class node{
        ...
        node next;
        boolean active= false;// deteris if current option is active or not
    }
    ...
    public static void addToHistory(int num, historyNode history){
                   ...
                   //debugging: System.out.println("historyid = "+ historyid);
                    ...
                    for(int i = historyid-1; i>0; i-- ){
                     ...
                     temp.next = newNode;
                    // System.out.print(newNode.id+ "- - - "+ newNode.num);
                    historyid++;
    ...
    public static void printHistory(historyNode history){ 
        System.out.println("There are "+ historyid+ " elements in the array");
        historyNode temp = history;
        while(temp !=null){
