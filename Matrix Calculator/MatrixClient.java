...
public class MatrixClient{
   public static void main(String[] args){
      ...
      System.out.println(A.getNNZ()); //first
      System.out.println(A);

      System.out.println(B.getNNZ()); //second
      System.out.println(B);

      Matrix C = A.scalarMult(1.5); //third 
      System.out.println(C.getNNZ());
      System.out.println(C);

      Matrix D = A.add(A); //fourth
      System.out.println(D.getNNZ());
      System.out.println(D);

      Matrix E = A.sub(A); //fifth
      System.out.println(E.getNNZ());
      System.out.println(E);
      //System.out.println("Here1");
      Matrix F = B.transpose(); //six
